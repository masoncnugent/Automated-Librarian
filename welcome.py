...
def creature_printer(creature_1, creature_2, creature_3):
    ...
    #This prints the title of the program surrounded by bars. It's automated to center itself between the 3 creatures chosen to be put into creature_printer().
    title_total_length = creature_1_metadata[1] + creature_2_metadata[1] + creature_3_metadata[1]
